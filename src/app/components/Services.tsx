...
const services = [
  {
    icon: Palette,
    title: "Design UI/UX",
    description: "Interfaces élégantes et intuitives qui séduisent et convertissent."
  },
  {
    icon: Code,
    title: "Développement",
    description: "Sites web sur mesure, performants et optimisés pour tous les devices."
  },
  {
    icon: Search,
    title: "SEO & Analytics",
    description: "Visibilité optimale et analyse en temps réel de vos performances."
  },
  {
    icon: Rocket,
    title: "Accompagnement",
    description: "Support continu et évolution de votre plateforme selon vos besoins."
  }
];

export function Services() {
  return (
    <section id="nos-services" className="py-32 bg-[#0E0E0E] relative overflow-hidden">
      {/* Background elements */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          >
            <span className="text-[#D070E5] tracking-widest uppercase text-sm">Expertise complète</span>
          </motion.div>
          ...
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                {/* Glow effect */}
                <div 
                  className="absolute -inset-0.5 bg-gradient-to-b from-[#D070E5] to-[#E3BDFF] rounded-2xl opacity-0 group-hover:opacity-40 blur-lg transition-opacity duration-500"
                />
                ...
                <div className="relative h-full backdrop-blur-xl bg-gradient-to-br from-white/[0.08] to-white/[0.02] border border-[#D070E5]/10 group-hover:border-[#D070E5]/40 rounded-2xl p-8 overflow-hidden transition-all duration-300">
                  ...
                  <div className="relative z-10">
                    ...
                    <h3 className="mb-3 text-white" style={{ fontSize: '1.25rem', fontWeight: '300' }}>
                      {service.title}
                    </h3>
