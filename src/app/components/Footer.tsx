...
export function Footer() {
  return (
    <footer id="contact" className="bg-black text-white py-20 relative overflow-hidden border-t border-[#D070E5]/10">
      {/* Background glow */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          >
            ...
            <p className="text-gray-400 max-w-md mb-8 leading-relaxed">
              Votre agence web créative et visionnaire, à la frontière entre innovation technologique 
              et proximité humaine. Transformons ensemble vos idées en expériences digitales inoubliables.
            </p>
          ...
          >
            <h4 className="mb-6 text-white" style={{ fontSize: '1.125rem', fontWeight: '300' }}>
              Navigation
            </h4>
        ...
        >
          ...
          <div className="flex items-center gap-8 text-sm">
            <a href="#" className="text-gray-500 hover:text-[#E3BDFF] transition-colors duration-300">
              Mentions légales
            </a>
            <a href="#" className="text-gray-500 hover:text-[#E3BDFF] transition-colors duration-300">
