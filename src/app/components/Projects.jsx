...
const projects = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1677214467820-ab069619bbb6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjB3ZWIlMjBkZXNpZ258ZW58MXx8fHwxNzYwMzAwMTQ5fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
  },
  {
    id: 2,
    ...
    image:
      "https://images.unsplash.com/photo-1704213684422-cd2543e560d6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtaW5pbWFsJTIwd2Vic2l0ZSUyMGludGVyZmFjZXxlbnwxfHx8fDE3NjAzNDkzOTN8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
  },
  {
    id: 3,
    ...
    category: "Design & SEO",
    image:
      "https://images.unsplash.com/photo-1760071744047-5542cbfda184?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjcmVhdGl2ZSUyMHBvcnRmb2xpbyUyMGRlc2lnbnxlbnwxfHx8fDE3NjAyOTcwMjB8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
  },
];
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #D070E5, #E3BDFF, #D070E5)",
              ...
              <div className="relative overflow-hidden rounded-2xl backdrop-blur-xl bg-gradient-to-br from-white/[0.05] to-white/[0.02] border border-[#D070E5]/20 group-hover:border-[#D070E5]/40 transition-all duration-500">
                ...
                <div className="p-6 relative">
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      <h3
                        className="mb-2 text-white group-hover:text-[#E3BDFF] transition-colors duration-300"
